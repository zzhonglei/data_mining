...
outputfile = '../tmp/new_reg_data_GM11.xlsx'  # 灰色预测后保存的路径
...
#
# inputfile = '../tmp/new_reg_data_GM11.csv'  # 灰色预测后保存的路径
...
# outputfile = '../tmp/new_reg_data_GM11_revenue.csv'  # SVR预测后保存的结果
